...
const Banner = () => {
    return (
        ...
        <div className="flex justify-between items-center px-10 lg:px-20 my-20 space-y-5 flex-col md:flex-row">
            ...
            <div>
                <div className="flex md:mx-0 mx-auto items-center gap-1.5 w-fit rounded-full bg-[#E1E7FF] py-2 px-4">
                    ...
                    <p className="text-sm sm:text-md font-semibold bg-gradient-to-r from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent">New: AI-Powered Tools Available</p>
                </div>
                <h1 className="font-extrabold mb-4 leading-tight text-gray-900 text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-center md:text-left">
                    Supercharge Your<p>Digital Workflow</p>
                </h1>
                <p className="text-md md:text-lg text-gray-500 mb-8 text-center md:text-left">
